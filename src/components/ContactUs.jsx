                ...
                <div className="bg-gray-100 p-6 rounded-lg shadow-md max-w-2xl mx-auto">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow mb-4">
                        ...
                        <ul className="mt-2 text-sm space-y-1">
                            <li>📍 Address: 62 Street 36, Van Phuc Urban Area, Thu Duc, Ho Chi Minh City</li>
                            <li>👤 Representative: Mr. Huynh Quoc Huy – Director</li>
                            <li>📞 Phone: 0901 234 567</li>
                            <li>📧 Email: <a href="mailto:contact@polysite.com" className="text-blue-600 hover:underline">contact@polysite.com</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow mb-4">
                        ...
                        <ul className="mt-2 text-sm space-y-1">
                            <li>📍 Address: 456 Le Thanh Tong Street, Hoan Kiem, Hanoi</li>
                            <li>👤 Representative: Mr. Tran Hoang Anh – Branch Manager</li>
                            <li>📞 Phone: 0912 345 678</li>
                            <li>📧 Email: <a href="mailto:hanoi@polysite.com" className="text-blue-600 hover:underline">hanoi@polysite.com</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow mb-4">
                        ...
                        <ul className="mt-2 text-sm space-y-1">
                            <li>📍 Address: 789 Tran Phu Street, Hai Chau, Da Nang</li>
                            <li>👤 Representative: Mr. Le Trung Hieu – Branch Manager</li>
                            <li>📞 Phone: 0934 567 890</li>
                            <li>📧 Email: <a href="mailto:danang@polysite.com" className="text-blue-600 hover:underline">danang@polysite.com</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow">
                        ...
                        <ul className="mt-2 text-sm space-y-1">
                            <li>📍 Address: 321 30/4 Street, Ninh Kieu, Can Tho</li>
                            <li>👤 Representative: Ms. Le Thi Hanh Mai – Branch Manager</li>
                            <li>📞 Phone: 0978 901 234</li>
                            <li>📧 Email: <a href="mailto:cantho@polysite.com" className="text-blue-600 hover:underline">cantho@polysite.com</a></li>
                        </ul>
                    </div>
                </div>
